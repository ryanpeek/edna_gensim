...
cat(paste(x_norm_s, collapse=","), file = glue::glue("results/dist_norm_ind{N}.txt"))

# Generate Uniform Distribution -------------------------------------------

x_unif <- runif(S)
x_unif_s <- sample(x_unif, Ngc) # take a sample
cat(paste(x_unif_s, collapse=","), file = glue::glue("results/dist_unif_ind{N}.txt"))
...
cat(paste(x_gamma_s, collapse=","), file = glue::glue("results/dist_gamma_ind{N}.txt"))
...
cat(paste(x_beta_s, collapse=","), file = glue::glue("results/dist_beta_ind{N}.txt"))
